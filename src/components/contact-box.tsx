...
const ContactInfo = () => {
  return (
    <div className="col-span-1 bg-primary-300 rounded-[30px] px-8 py-[76px] flex flex-col gap-[30px] w-full">
      ...
      <h5 className="flex flex-col xl:flex-row gap-4 items-center text-xl font-jost tracking-tight">
      Inspections are more than welcome, but we do ask you contact us prior to arrival - feel free to call or email to arrange a suitable time. Our friendly staff will give you a personal tour of our facilities prior to booking so you can ask any questions and be 100% satisfied before leaving your cat with us.
      </h5>
    </div>
  );
};
